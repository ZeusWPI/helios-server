...
echo "from helios_auth.models import User; User.update_or_create(user_type='password', user_id='admin', name='admin', info={'password': 'password', 'email': 'admin@zeus.ugent.be'})" | python manage.py shell || true
